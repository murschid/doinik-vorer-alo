                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="caption" class="form-control" required placeholder="Photo caption" minlength="3" maxlength="140">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label>Thumbnail <span class="text-danger">* [4:3 small]</span></label>
                                        <input type="file" name="thumbnail" class="form-control" required id="inputThumb">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label>Photo <span class="text-danger">* [16:9 medium]</span></label>
                                        <input type="file" name="photo" class="form-control" required id="inputPhoto">
                                    </div>
                                </div>
                                <div class="col-lg-1">
                                    <div class="form-group">
