    ...
    <div class="jumbotron rounded">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <p class="text-center"><a href="tel:01712231390" class="font-weight-normal"><?= lang('mobileno'); ?></a></p>
            </div>
            <div class="col-sm-4">
                <div class="text-center pb-2">
                ...
                <p class="text-center myfont abbr"><a href="mailto:doinikvoreraloi@gmail.com" class="font-weight-normal"><?= lang('emailadd'); ?></a></p>
            </div>
        </div>
    </div>
    <div class="mb-2">
